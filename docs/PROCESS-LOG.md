...
## Keputusan 56 — Skrip yang crash lebih buruk daripada skrip yang tidak ada
...
## Keputusan 57 — Gerbang yang buta tidak boleh mengaku hijau
...
## Keputusan 58 — Dua salinan test yang sama menghitung diri dua kali
...
## Keputusan 59 — Jejak audit sempat berbohong soal integritas perangkat
...
## Keputusan 60 — SDK dapat tempatnya sebelum kodenya ada
...
## Keputusan 61 — Tag biaya diparse dan diungkapkan, tapi tidak diskor
...
Urutan yang sama dengan tag 58 di Keputusan 55: ungkapkan dulu, skor
...
## Keputusan 62 — Panel forensik TLV: opt-in di kontrak, mode demo di UI

Kelanjutan Keputusan 61. Usulan "layer forensik" ditolak sebagai layer,
...
## Keputusan 63 — Membayar menuntut ditahan, dan namanya ada di tombolnya
...
## Keputusan 64 — Kartu hasil: satu angka bersekala, klaim dipisah dari putusan
...
## Keputusan 65 — Tiket verifikasi: mengikat, bukan memaksa
...
tingkat infrastruktur, bukan tingkat pustaka. Tercatat sebagai R15.
...
1. **R14** — simetris berarti bahan kuncinya ada di konfigurasi. Bocornya
...
**R16 — replay dalam masa berlaku.** Tiketnya stateless dan tidak
...
| Parameter | Nilai | Alasan |
|---|---|---|
| `W_STRUCTURAL` | 70 | kontradiksi spec, bukan kemiripan statistik — 0 positif palsu dari 20.000 payload sah. Dipakai `static_qr_with_amount`, `missing_mandatory_tags`, `malformed_nmid`, dan `malformed_country` (Keputusan 55) |
...
pernah menyentuh penilaian — lihat Keputusan 61.
